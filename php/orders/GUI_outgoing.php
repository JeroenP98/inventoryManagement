...
<body class="d-flex flex-column h-100">
  <header class="p-3 mb-3 border-bottom">
    ...
    <div class="modal fade" id="newOrderModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="controller_orders.php?action=add&order_type=outgoing">
    ...
    <div class="d-flex align-items-center mb-5">
      ...
      <a href="../include/exportData.php?report=exportOrders&type=outgoing" class="btn btn-success my-3">Export</a>
        ...
        <form method="get">
          <div class="form-group row align-items-center">
            ...
            <select class="form-control" id="order_by" name="order_by">
                ...
                <option value="order_date_asc">Order date (Ascending)</option>
                <option value="order_date_desc">Order date (Descending)</option>
                <option value="shipping_date_asc">Shipping date (Ascending)</option>
                <option value="shipping_date_desc">Shipping date (Descending)</option>
                <option value="num_lines_asc">No. order lines (Ascending)</option>
                <option value="num_lines_desc">No. order lines (Descending)</option>
              </select>
            </div>
            <div class="col-sm-3">
              <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <!-- End actions bar-->
      <table class="table table-striped table-sm" id="table">
        ...
        if(isset($_GET["order_by"])){
          ...
          switch($get_order_by) {
            ...
            case "order_date_desc":
              ...
              break;
            case "shipping_date_asc":
              $order_by = "shipping_date ASC"; 
              break;
            case "shipping_date_desc":
              $order_by = "shipping_date DESC"; 
              break;
            case "num_lines_asc":
              $order_by = "num_of_lines ASC"; 
              break;
            case "num_lines_desc":
              $order_by = "num_of_lines DESC"; 
              break;
            default:
              $order_by = "id ASC";
          }
        ...
        $sql = "SELECT orders.id as id, relations.name as name, orders.order_date as order_date, orders.shipping_date as shipping_date, COUNT(order_lines.order_id) AS num_of_lines, employees.first_name as verkoper_name, IF(orders.is_finalized = 1, 'Yes', 'No') as is_finalized 
        FROM orders
        JOIN relations
