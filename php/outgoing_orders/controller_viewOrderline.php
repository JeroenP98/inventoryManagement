...
<head>
  ...
  <title>Orderline | GreenHome</title>
</head>
<body>
  <header class="p-3 mb-3 border-bottom">
    ...
    <!--Page data-->
    <div class="container">
      <h1>Outgoing orderline</h1>
      <a href="GUI_outgoing.php" class="btn btn-primary">Back</a>
      ...
      <table class="table table-striped table-sm" id="table">
        ...
        // select database
        $sql = "SELECT order_lines.order_line as id, articles.name as article, order_lines.quantity as quantity, articles.selling_price as price, articles.description as description
        FROM order_lines
        JOIN orders
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <td>$row[quantity]</td>
          <td>
          <a class='btn btn-danger' href='controller_orderlineDelete.php?id=$row[id]'>Delete</a>
          </td>
          </tr>";
