...
<body>
  ...
  <div class="container">
    ...
    <div class="input-group my-3">
      <span class="input-group-text" id="tableSearchBar">Search for Relation</span>
      <input type="text" class="form-control" id="searchInput" placeholder="Relation name..." aria-label="articlename" aria-describedby="tableSearchBar" onkeyup="tableSearch()">
    </div>
    <!-- End search bar-->
