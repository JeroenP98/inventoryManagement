        ...
        <div class="row ">
            <div class="col-8">
                <div class="Background-clean-environment">
                     <img src="../images/sustainability2.png" alt="cleaning the environment" class="w-1267 h-356">
                </div>
            </div>
            <div class="col-4">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="Background-clean-environment4">
                     <img src="../images/sustainability3.png" alt="cleaning the environment" class="w-1267 h-356">
                </div>
            </div>
        </div>
</div>
...
<div class="container">
        <div class="row">
            <div class="col-8">
                <div class="Background-clean-environment">
                     <img src="../images/sustainability4.png" alt="cleaning the environment" class="w-1267 h-356">
                </div>
            </div>
            <div class="col-4">
                <div class="Background-clean-environment2">
