  ...
  <main class=" d-flex justify-content-center py-4">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
      ...
      <div class="col">
        <div class="card mt-4 d-flex justify-content-center">
          <div class="card-header">
              <h4>Top Employees by Total Turnover</h4>
          </div>
          <div class="card-body">
            <?php
              ...
              <form method="post" class="row">
                <div class="form-floating mr-2 col-9">
              ...
              <script>
                  ...
                  document.getElementById('month').addEventListener('change', function() {
                      ...
                      // make an AJAX request to get the data for the selected month
                      ...
                      xhttp.open('GET', 'get_data.php?month=' + selectedMonth, true);
                      xhttp.send();
                  });
                  </script>
